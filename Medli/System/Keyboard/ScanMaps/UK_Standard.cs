...
namespace Medli.System.ScanMaps
{
    class UK_Standard : ScanMapBase
    {
		public UK_Standard()
		{
		...
		protected override void InitKeys()
		{
			...
			_keys.Add(new KeyMapping(0x27, ';', ':', ';', ';', ':', ':', ConsoleKeyEx.Semicolon));
			...
			_keys.Add(new KeyMapping(0x54, ConsoleKeyEx.PrintScreen));
			_keys.Add(new KeyMapping(0x5b, ConsoleKeyEx.LWin));
			_keys.Add(new KeyMapping(0x5c, ConsoleKeyEx.RWin));
			_keys.Add(new KeyMapping(0xE1, ConsoleKeyEx.PauseBreak));
