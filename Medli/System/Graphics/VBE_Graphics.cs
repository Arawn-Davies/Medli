...
using System.Linq;
using Medli.System.xConsole;
using System.Text;
using System.Threading.Tasks;
using Medli.Hardware.Drivers.Video;
using static System.Net.Mime.MediaTypeNames;

namespace Medli.System.Graphics
{
	unsafe class VBE_Graphics
	{

		public static VBE_Driver Canvas;
		...
		public VBE_Graphics()
		{
			...
			//OEM String
			byte* oemptr = GetOemString(ControllerInfo.oemStringPtr, (byte*)Cosmos.Core.Memory.Heap.Alloc(200), 200);
			...
			{
				VBE_Console.mRows = (int)ConsoleMode.Mode1280x768.Rows;
				VBE_Console.mWidth = (int)ConsoleMode.Mode1280x768.Rows;
				VBE_Console.mCols = (int)ConsoleMode.Mode1280x768.Cols;
				VBE_Console.mHeight = (int)ConsoleMode.Mode1280x768.Cols;
				VESAMode = "Mode1280x768";
			}
			else if (ModeInfo.width == (1280) && ModeInfo.height == (800))
			{
				VBE_Console.mRows = (int)ConsoleMode.Mode1280x800.Rows;
				VBE_Console.mWidth = (int)ConsoleMode.Mode1280x800.Rows;
				VBE_Console.mCols = (int)ConsoleMode.Mode1280x800.Cols;
				VBE_Console.mHeight = (int)ConsoleMode.Mode1280x800.Cols;
				VESAMode = "Mode1280x800";
			}
			else if (ModeInfo.width == (1600) && ModeInfo.height == (1200))
			{
				VBE_Console.mRows = (int)ConsoleMode.Mode1600x1200.Rows;
				VBE_Console.mWidth = (int)ConsoleMode.Mode1600x1200.Rows;
				VBE_Console.mCols = (int)ConsoleMode.Mode1600x1200.Cols;
				VBE_Console.mHeight = (int)ConsoleMode.Mode1600x1200.Cols;
				VESAMode = "Mode1600x1200";
			}
			else if (ModeInfo.width == (1152) && ModeInfo.height == (864))
			{
				VBE_Console.mRows = (int)ConsoleMode.Mode1152x864.Rows;
				VBE_Console.mWidth = (int)ConsoleMode.Mode1152x864.Rows;
				VBE_Console.mCols = (int)ConsoleMode.Mode1152x864.Cols;
				VBE_Console.mHeight = (int)ConsoleMode.Mode1152x864.Cols;
				VESAMode = "Mode1152x864";
			}
			else if (ModeInfo.width == (1360) && ModeInfo.height == (768))
			{
				VBE_Console.mRows = (int)ConsoleMode.Mode1360x768.Rows;
				VBE_Console.mWidth = (int)ConsoleMode.Mode1360x768.Rows;
				VBE_Console.mCols = (int)ConsoleMode.Mode1360x768.Cols;
				VBE_Console.mHeight = (int)ConsoleMode.Mode1360x768.Cols;
				VESAMode = "Mode1360x768";
			}
			else if (ModeInfo.width == (1366) && ModeInfo.height == (768))
			{
				VBE_Console.mRows = (int)ConsoleMode.Mode1366x768.Rows;
				VBE_Console.mWidth = (int)ConsoleMode.Mode1366x768.Rows;
				VBE_Console.mCols = (int)ConsoleMode.Mode1366x768.Cols;
				VBE_Console.mHeight = (int)ConsoleMode.Mode1366x768.Cols;
				VESAMode = "Mode1366x768";
			}
			else if (ModeInfo.width == (800) && ModeInfo.height == (600))
			{
				VBE_Console.mRows = (int)ConsoleMode.Mode800x600.Rows;
				VBE_Console.mWidth = (int)ConsoleMode.Mode800x600.Rows;
				VBE_Console.mCols = (int)ConsoleMode.Mode800x600.Cols;
				VBE_Console.mHeight = (int)ConsoleMode.Mode800x600.Cols;
			...
			{
				Canvas = new VBE_Driver(ModeInfo.width, ModeInfo.height, ModeInfo.framebuffer, true);
			}
			else
			{
				Canvas = new VBE_Driver(ModeInfo.width, ModeInfo.height, ModeInfo.framebuffer, false);
			}
		...
		public void DrawImage(ushort X, ushort Y, ushort Length, ushort height, Imaging.Image image)
		{
			int z = 0;
		...
		private void drawChar(char c)
		{
			...
			if (Kernel.xConsole.Background != ConsoleColor.Black)
			{
				for (int cy = 0; cy < 16; cy++)
				{
					for (byte cx = 0; cx < 9; cx++)
					{
						Canvas.SetPixel((ushort)((9 * (Kernel.xConsole.X)) + (9 - cx)), (ushort)((16 * (Kernel.xConsole.Y)) + cy), (Pallete[(int)Kernel.xConsole.Background]), true);
					}
				}
				for (int cy = 0; cy < 16; cy++)
				{
					for (byte cx = 0; cx < 8; cx++)
					{
						...
						{
							Canvas.SetPixel((ushort)((9 * (Kernel.xConsole.X)) + (9 - cx)), (ushort)((16 * (Kernel.xConsole.Y)) + cy), (Pallete[VBE_Console.foreground]), true);
						}
						else
						{
							Canvas.SetPixel((ushort)((9 * (Kernel.xConsole.X)) + (9 - cx)), (ushort)((16 * (Kernel.xConsole.Y)) + cy), 0, true);
						}
					}
				}
			}
			else
			{
				for (int cy = 0; cy < 16; cy++)
				{
					for (byte cx = 0; cx < 8; cx++)
					{
						if (getb(Font[p + cy], cx + 1))
						{
							Canvas.SetPixel((ushort)((9 * (Kernel.xConsole.X)) + (9 - cx)), (ushort)((16 * (Kernel.xConsole.Y)) + cy), (Pallete[VBE_Console.foreground]), false);
						}
						else
						{
							Canvas.SetPixel((ushort)((9 * (Kernel.xConsole.X)) + (9 - cx)), (ushort)((16 * (Kernel.xConsole.Y)) + cy), 0, false);
						}
					}
				}
			}
		...
		public void WriteByte(byte ch)
		{
			...
			else if (c == '\n')
			{
				...
				if (Kernel.xConsole.Y == Kernel.xConsole.Cols)
				{
					ScrollUp();
					Kernel.xConsole.Y--;
				}
			...
			if (Kernel.xConsole.X == Kernel.xConsole.Rows)
			{
				if (Kernel.xConsole.Y == Kernel.xConsole.Cols - 1)
				{
					ScrollUp();
				}
				else
